...
sumLast2 :: Int -> Int
sumLast2 n =
  let lastTwoDigits = mod n 100
      lastTwoSum = (mod lastTwoDigits 10) + (div lastTwoDigits 10)
   in lastTwoSum
...
-- @
-- sumLast2 :: Int -> Int
-- sumLast2 n = penumDig (digs n)
--   where
--     -- digs returns the last two digits of a number
--     digs :: Int -> Int
--     digs x = mod x 100
--     penumDig :: Int -> Int
--     penumDig x = mod x 10 + div x 10
-- @
--}
